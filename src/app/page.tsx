  ...
  return (
    <div className="font-sans min-h-screen">
      <main className="px-6 sm:px-10 md:px-16 lg:px-24 py-16 sm:py-24">
        <section className="max-w-6xl mx-auto text-center sm:text-left">
          <div className="rounded-3xl border border-black/[.08] dark:border-white/[.145] p-8 sm:p-12 bg-gradient-to-br from-black/[.02] to-black/[.06] dark:from-white/[.04] dark:to-white/[.08]">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold tracking-tight text-balance">
              Authentic Korean Groceries. Shop in-store today.
            </h1>
